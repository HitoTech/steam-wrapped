...
def get_owned_games(steamid: str, include_free: bool = False, include_appinfo: bool = True):
...
def get_played_games(steamid: str, include_free: bool = False, include_appinfo: bool = True):
...
def get_played_games_on_last_2_weeks(steamid: str, include_free: bool = False, include_appinfo: bool = True):
    all_games = get_owned_games(steamid, include_free, include_appinfo)
...
if __name__ == "__main__":
    if not STEAM_API_KEY or not STEAM_USER_ID:
        ...
        display_games_table("🕒 Jeux joués les 2 dernières semaines", played_games_last_2_weeks, "playtime_2weeks")
